...
int write_queue_ring_op(ring_queue* ring, uchar* buf, uint len);

int read_queue_ring_op(ring_queue* ring, uchar* buf, uint len);

int read_all_queue_ring_op(ring_queue* ring);
